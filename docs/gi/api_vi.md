...
- [Thông tin Cấu trúc Dữ liệu](#data-structure)
...
| Tên | Mô tả |
| :--- | :---------- |
| nameTextHashMap | Hash cho Tên Trang bị <br /> Kiểm tra [Bản địa hóa](#localizations) |
| setNameTextHashMap `[Chỉ Thánh di vật]`| Hash cho Tên Bộ Thánh di vật <br /> Kiểm tra [Bản địa hóa](#localizations)|
...
| icon | Tên Biểu tượng Trang bị <br /> [Cách dùng tên biểu tượng](#icons-and-images)|
