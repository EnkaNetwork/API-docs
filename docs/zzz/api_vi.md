...
- Trong khi làm việc với chỉ số nhân vật, vũ khí và đĩa, bạn nên tham khảo [Công thức](#công-thức). Cảm ơn rất nhiều đến Mero vì đã đảo ngược kỹ thuật và lấy được các công thức thực tế được sử dụng trong game.
...
| Tên | Mô tả |
| :--- | :--------- |
| MedalType | [Loại Huy hiệu](#loại-huy-hiệu) |
| Value | Số Tiến độ |
...
| SkillLevelList | Dict cấp độ kỹ năng Người đại diện, kiểm tra [định nghĩa](#kỹ-năng) cho các chỉ mục |
...
Kiểm tra [Công thức](#công-thức) để xem cách lấy giá trị thực tế từ giá trị cơ bản
