> ### ⚠️ Diese Übersetzung ist noch in Arbeit. Inhalte könnten unfertig oder fehlerhaft sein.
> #### Greife im Zweifel zur [Englischen Originalfassung](/api.md) zurück.
...
- [Informationen zur Datenstruktur](#informationen-zur-datenstruktur)
- [Definitionen](#definitionen)
- [Symbole und Bilder](#symbole-und-bilder)
...
See [Wrapper](#wrapper) for the language of your choice.
...
#### Erhalte Showcase-Daten mit vollständigen Spielerinformationen
...
#### Erhalte nur Spielerinformationen
...
```
400 = Falsches UID-Format
404 = Spieler existiert nicht (laut den MHY-Servern)
424 = Wartungsarbeiten am Spiel / Alles nach dem Spieleupdate ist kaputt
429 = Übertragungsbegrenzung (entweder durch meinen Server oder den von MHY)
500 = Allgemeiner Serverfehler
503 = Ich habe massiv verkackt
```
...
| 28 | Elementarkunde |
| 29 | Physical RES |
| 30 | Physischer-SCH-Bonus |
| 40 | Pyro-SCH-Bonus |
| 41 | Elektro-SCH-Bonus |
| 42 | Hydro-SCH-Bonus |
| 43 | Dendro-SCH-Bonus |
| 44 | Anemo-SCH-Bonus |
| 45 | Geo-SCH-Bonus |
...
### Figuren, Talente and Sternbilder
